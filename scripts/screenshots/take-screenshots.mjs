// Playwright screenshot script for the theDAW UI.
...
(async () => {
  ...
  try {
    ...
    // Wait for the theDAW logo to appear so we know the React tree is mounted.
    await page.waitForSelector('text=theDAW', { timeout: 10000 });
    ...
    await page.waitForSelector('text=theDAW Docs', { timeout: 5000 });
