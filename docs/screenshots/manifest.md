...
| `41-score-strip.png` | full | 41-score-strip | `library-midi-conversion` | §13 Bottom Panel Tabs |
| `42-score-highway.png` | full | 42-score-highway | `library-midi-conversion` | §13 Bottom Panel Tabs |
| `43-sing-karaoke.png` | full | 43-sing-karaoke | `library-midi-conversion` | §13 Bottom Panel Tabs |
| `44-draw.png` | full | 44-draw | `piano-roll-linked-clip-editing` | §13 Bottom Panel Tabs |
